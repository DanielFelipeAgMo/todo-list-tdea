  ...
  return (
    <div className="bg-white shadow-lg px-5 py-10 rounded-lg mt-5">
        ...
        <div className="flex justify-between">
          <button className="bg-green-500 hover:bg-green-700 mt-4 py-2 px-10 rounded-full text-white font-bold" type="button" onClick={()=> settarea(tarea)}>Update</button>
          <button className="bg-red-300 hover:bg-red-700 mt-4 py-2 px-10 rounded-full text-white font-bold"type="button">Delete</button>
        </div>
    </div>
  )
}
